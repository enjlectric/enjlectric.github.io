            ...
            <div>
                ...
                <div>
                    ...
                    <div className="blogdiv">
                        ...
                        We've talked a lot about completion in the context of when you as the player choose to step away from a game, but as is so often the case on my blog, the things I eject onto the page look at a very narrow case and then say that the thought is applicable to somewhat related fields.<br/><br/>In this case, I want to talk about the scenario where you as a creator are completing a project and there is nothing more to do but to show it to the world.<br/><br/>It's a hollow feeling to complete your creative outlet. It's stressful and there is a lot of uncertainty tied to it due to not knowing how people will react.<br/><br/>You can think of this as the final boss of the project. But where a game has the entire story head towards an engineered satisfying conclusion, the release of a project is not engineered, and is moreso a chapter transition into the post-release/post-game phase.<br/><br/>You might've hit arbitrary achievements along the way cause your development cycle was designed like shit, and at this point I don't know where this metaphor is going anymore.<br/><br/>Point is, from the creator's side, it's best to avoid silly things like "playing the rest of development in your mind because it's more fun than actually doing it and hitting against the boundaries of your own capability".<br/><br/>Because creating begets creation, and no matter the scope that had to be cut, the act of completion is something to be proud of.
                    </div>
                </div>
                }
            </div>
