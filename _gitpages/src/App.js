...
class App extends React.Component {
    ...
    mainPage() {
        return <div>
            ...
            {(this.state.state == 6 && this.state.elaborate) && <About></About>}
        </div>
    }
    ...
    render() {
        return (
            <div className="App">
                <Router>
                    {!this.state.elaborate && <div className="top">
                        <img className="logo" src={this.state.elaborate ? logo : logo2} alt={"Game Design & more by <br>" + (this.state.elaborate ? "Henri 'Enjl' Beeres" : "Enjl")}></img>
            ...
            {console.log(this.state.state)}
                    ...
                    <div className="outerBorder">
                        ...
                        {(this.state.elaborate && this.state.state == 0) && <div>
                            <About/>
                            <div className="divider"></div>
                        </div>
                        }

                        {(this.state.elaborate == true  && this.state.state == 0) && <h1>
                            Projects
                        </h1>}
                        {this.mainPage()}
                        ...
                        {(this.state.elaborate == true) && 
                            <div style={{textAlign: "center"}}>
                                ...
                                <p>
                                    If you would like to get in touch, please contact me at <a className="coolLink" style={{padding: "2px 6px"}} href="mailto:henri.beeres@unitybox.de">henri.beeres@unitybox.de</a> or shoot me a DM on Discord at @Enjl#6208.
                                </p>
