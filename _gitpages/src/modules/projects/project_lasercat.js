    ...
    render() {
        return (
            <div className="projectPage">
                ...
                <p>
                    To aid the game's replayability, I have strung the scenes together in a loop, where Wave 9 onwards sees the player revisiting the previous levels. However, <span>they are not exactly the same</span>. On top of linear score and HP scaling for enemies, the spawners are configured to have lower and upper spawn bounds. This allows me to swap out entire enemy waves with the spawner only having to read the iteration count variable. For a practical example: In iterations 3 and 4, players fight two of each boss. In iteration 5 onward, players fight three of each boss.
                </p>
                <p>
                    The game's structure is defined via Unity's <span>Scriptable Objects</span>. The data-driven approach made it easy to tweak settings such as scaling factors on the fly and allowed me to effortlessly add new global elements such as projectiles, sound effects and death effects.
                </p>
                ...
                <p>
                    Something that caused a lot of unexpected trouble for me was working with a <span>sprite-based font</span> in TextMeshPro. This is the first time I've tried using a sprite-based font in Unity, and I find it quite cumbersome, especially after using configuration files where I was able to simply supply a glyph map and optional per-glyph settings.
                </p>
                <p>
                ...
                <span>Laser Cat is available for free on: <a target="_blank" rel='noreferrer' href="https://enjl.itch.io/laser-cat">Itch.io</a></span>
            </div>
        )
    }
}
