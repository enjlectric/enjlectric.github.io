    ...
    render() {
        return (
            <div className="projectPage">
                ...
                <p>
                    <span className="hl">Project Flurret</span> is an ongoing side project of mine. It's a 2D side-scrolling metroidvania with a focus on exploration and friendship. It's very early into development and as such the focus of this post will be mostly revolving systems I have built for it.
                </p>
                ...
                <p>
                    For the initial prototyping, the player character used a rigidbody-based system with hard-set velocity values. Upon the introduction of moving platforms, this temporary system swiftly showed its weaknesses and I began work on a proper character controller. The current controller uses <span className="hl">orthogonal boxcasts</span> to determine its touch points and invokes onCollision-Events on touching elements that implement the ICollidable interface. As per a friend's recommendation, moving platforms are responsible for handling the motion of attached entities themselves, invoking a TryMove-Function on the entity which returns whether or not the entity was able to move the intended distance (for crush checks).
                </p>
                <p>
